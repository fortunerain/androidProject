 ...
 */
public class GroupActivityListViewAdapter extends ArrayAdapter<ActivityModel> {
    ...
    public GroupActivityListViewAdapter(Context context, int resource, List<ActivityModel> objects, LayoutInflater layoutInflater) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.adapter_group_listview, parent, false);
            //holder
            ImageView img_acti_icon = (ImageView) convertView.findViewById(R.id.img_group_acti_icon);
            TextView text_acti_header = (TextView) convertView.findViewById(R.id.text_group_acti_header);
            TextView text_acti_body = (TextView) convertView.findViewById(R.id.text_group_acti_body);
